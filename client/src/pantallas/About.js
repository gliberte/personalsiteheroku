                ...
                <InnerContent>
                    ...
                    <TextContainer>
                        ...
                        <p>Ingresé a la Universidad de Panamá para estudiar Licenciatura en Matemática con la idea de 
                            dedicarme a la docencia. Mala idea para un extranjero. La programación siempre fue de mucho interés para mi. 
                            En la universidad invertía más del tiempo necesario en los laboratorios de informática, después de las clases regulares 
                            del curso de programación con Turbo Basic para la aplicación de métodos numéricos, y jugaba con los compiladores. 
                            Mi primer programa fue un juego de apuestas de carreras de caballos simulada. Al terminar la licenciatura en matemáticas quice iniciar 
                            la carrera de ingiería informática; pero mi situación económica ya como adulto y el de mi familia no me permitieron concretar esa idea.
                            Tuve que hacerme a la idea de buscar empleo y olvidarme por el momento de la informática.
                        </p>    
                        <p>
                            Los empleos para un extranjero en docencia eran muy escasos. Al recibir mi diploma busqué trabajo dictando cursos sobre computadoras 
                            (MS-DOS,Word,Excel,WordPerfect,Window 3.11,etc). Luego, conseguí trabajo como 
                            profesor de Informática y de matemáticas en algunas escuelas privadas. Finalmente, decidí que la profesion de docente no era para mi, asi que empecé a complementar 
                            mis conocimientos sobre 
                            computadoras por cuenta propia. Aprendí a usar programas informáticos sobre GIS (Geographic Information Systems) y los rudimentos sobre esa apacionante disciplina.
                        ...
                        <p>
                            ...
                            ambiente de desarrollo, fui capacitándome por mi cuenta en la programación con Javascript,HTML y CSS. Luego 
